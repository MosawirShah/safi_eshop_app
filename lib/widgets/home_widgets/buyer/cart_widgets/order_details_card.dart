...
import 'package:safi_e_shop/screens/buyer/order_done_screen.dart';
            ...
            Row(
              ...
              children: [
                Padding(
                    ...
                    padding: EdgeInsets.only(
                        top: 15.0, bottom: 15.0, left: 10.0, right: 110.0)),
                Padding(
                    child: Text(
                      "\$${getTotalPrice(provider.cartProducts)*provider.cartProducts.length}",
                      textAlign: TextAlign.start,
                      style: TextStyle(
                        color: Color(0xff2C2C54),
                        fontSize: 16,
            ...
            Row(
              ...
              children: const [
                Padding(
                    ...
                    padding: EdgeInsets.only(
                        top: 15.0, bottom: 15.0, left: 10.0, right: 60.0)),
                Padding(
                    child: Text(
                      "+\$10.00",
                      textAlign: TextAlign.start,
            ...
            Row(
              ...
              children: [
                Padding(
                    ...
                    padding: EdgeInsets.only(
                        top: 15.0, bottom: 15.0, left: 10.0, right: 120.0)),
                Padding(
                    child: Text(
                      "\$${getTotalPrice(provider.cartProducts)*provider.cartProducts.length + 10}",
                      textAlign: TextAlign.start,
                      style: TextStyle(
                        color: Color(0xff2C2C54),
                        fontSize: 16,
